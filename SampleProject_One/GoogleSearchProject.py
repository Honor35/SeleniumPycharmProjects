...
if __name__ == '__main__':
        unittest.main(testRunner=HtmlTestRunner.HTMLTestRunner(output="C://Users//computer//PycharmProjects//SeleniumTutorialPractice//SampleProject_Two//Report"),verbosity=2)